...
const ShopStatistics = ({ timePeriod, user }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (user) {
          const response = await userService.getDustbinHistory(user._id);
          dustbinHistoryData = response.data;
          console.log(dustbinHistoryData);
        } else {
          const response = await userService.getDustbinHistory();
          dustbinHistoryData = response.data;
          console.log(dustbinHistoryData);
        }
